...
export default function DebugPage() {
  ...
  const [apiResponse, setApiResponse] = useState<Record<string, unknown> | string | null>(null);
    ...
    const getEnvVars = () => {
      ...
      Object.keys(window).forEach(key => {
        if (key.startsWith('__NEXT_DATA__')) {
          try {
            const nextData = (window as unknown as Record<string, unknown>)[key];
            if (nextData && typeof nextData === 'object' && nextData !== null) {
