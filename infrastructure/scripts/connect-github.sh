...
echo "Connecting GitHub to Amplify app for environment: $ENVIRONMENT"
...
echo ""
echo "After connecting your repository, Amplify will automatically build and deploy your application." 